     ...
     ///////////////////////////////////////////////////////////////////////////////
       ...
       /*
         ...
         */
         ...
         ///////////////////////////////////////////////////////////////////////////////
         // 																		  //
         //    NOTE: Above Tests were created for Assignment #3 white-box testing    ///
         // 																		  //
         ///////////////////////////////////////////////////////////////////////////////
         // 																		  //
         //   NOTE: Below Tests were created for Assignment #4 mutation  testing     ///
         // 																		  //
         ///////////////////////////////////////////////////////////////////////////////
         
         // Kolby's Added mutation tests
         
         //Increases mutation coverage on intersects by making close overlap
         @Test
         public void getIntersectsTestUpperBoundCloseMatch() {
             boolean correct = true;
             boolean inter = exampleRange6.intersects(exampleRange4);
             assertEquals(correct,inter);
         }
         
         //Increases mutation coverage on intersects by making close overlap
         @Test
         public void getIntersectsTestLowerBoundCloseMatch() {
             boolean correct = true;
             boolean inter = exampleRange4.intersects(exampleRange6);
             assertEquals(correct,inter);
         }
         
         //Increases mutation coverage on intersects by making full overlap over smaller range
         @Test
         public void getIntersectsTestInside() {
             boolean correct = true;
             boolean inter = exampleRange4.intersects(exampleRange5);
             assertEquals(correct,inter);
         }
         
         // This test increases the mutation coverage by forcing the bounds to switch
         @Test
         public void expandTestLowerGreaterThanUpper() {
             Range range = new Range(5.0, 10.0);
             Range newR = Range.expand(range, 0.0, -2.0);
             assertEquals(2.5, newR.getLowerBound(),0.0);
             assertEquals(2.5, newR.getUpperBound(),0.0);
         }
         
        
      // This test increases the mutation coverage by combining upper bound NaN 
         @Test
         public void testCombineIgnoringNaNWithUpperNaN() {
             
             Range exampleRangeNaN1 = new Range(0.0, Double.NaN);
             Range exampleRangeNaN2 = new Range(2.0, Double.NaN);
             Range combined = Range.combineIgnoringNaN(exampleRangeNaN1, exampleRangeNaN2);
             assertEquals(0.0, combined.getLowerBound(),0.0);
             assertEquals(Double.NaN, combined.getUpperBound(),0.0);
         
         }
         
      // This test increases the mutation coverage by combining lower bound NaN 
         @Test
         public void testCombineIgnoringNaNWithLowerNaN() {
             
             Range exampleRangeNaN1 = new Range(Double.NaN, 5.0);
             Range exampleRangeNaN2 = new Range(Double.NaN, 0.0);
             Range combined = Range.combineIgnoringNaN(exampleRangeNaN1, exampleRangeNaN2);
             assertEquals(Double.NaN, combined.getLowerBound(),0.0);
